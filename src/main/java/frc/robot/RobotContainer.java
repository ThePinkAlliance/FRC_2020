...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    new JoystickButton(mainJS, 3).whenHeld(new ShooterAim(m_shooter));
    ...
    new JoystickButton(gunnerJS, 1).whenPressed(new ClimbersUp(m_climber, Constants.climbToMid));
    new JoystickButton(gunnerJS, 2).whenPressed(new ClimbersUp(m_climber, Constants.climbToRight));
    new JoystickButton(gunnerJS, 3).whenPressed(new ClimbersUp(m_climber, Constants.climbToLeft));
    new JoystickButton(gunnerJS, 4).toggleWhenPressed(new ClimbersUnlock(m_climber));
